...
function loom(data) {
  ...
  function loom(data) {
    ...
    if (sortSubgroups) {
      subgroupIndex.forEach((d, i) => {
        d.sort((a, b) => sortSubgroups(
						inner(data[i].values[a]),
						inner(data[i].values[b]),
					));
      });
    }
    ...
    if (sortSubgroups) { uniqueInner.sort((a, b) => sortSubgroups(a.name, b.name)); }
  ...
  loom.widthInner = function (_) {
    return arguments.length
			? ((widthInner = typeof _ === 'function' ? _ : constant$11(+_)), loom)
			: widthInner;
  };

  loom.emptyPerc = function (_) {
    return arguments.length
			? ((emptyPerc = _ < 1 ? max$1(0, _) : max$1(0, _ * 0.01)), loom)
			: emptyPerc;
  };
  ...
  loom.sortLooms = function (_) {
    return arguments.length
			? (_ == null
					? (sortLooms = null)
					: ((sortLooms = compareValue(_))._ = _), loom)
...
function string() {
  ...
  string.radius = function (_) {
    return arguments.length
			? ((radius = typeof _ === 'function' ? _ : constant$11(+_)), string)
			: radius;
  };
  ...
  string.groupStartAngle = function (_) {
    return arguments.length
			? ((groupStartAngle = typeof _ === 'function'
					? _
					: constant$11(+_)), string)
			: groupStartAngle;
  };

  string.startAngle = function (_) {
    return arguments.length
			? ((startAngle = typeof _ === 'function' ? _ : constant$11(+_)), string)
			: startAngle;
  };

  string.endAngle = function (_) {
    return arguments.length
			? ((endAngle = typeof _ === 'function' ? _ : constant$11(+_)), string)
			: endAngle;
  };
